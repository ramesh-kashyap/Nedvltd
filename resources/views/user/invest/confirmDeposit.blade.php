            ...
            <div data-v-37526a6c="" id="content" class="content-scroll" style="padding-bottom: 0.3rem;">
                <div data-v-37526a6c="" class="container page-recharge">
                    <div data-v-37526a6c="" class="page-recharge-qrcode">
                        <div data-v-37526a6c="" id="qrcode" title="{{$walletAddress}}">
                            <canvas width="691" height="691" style="display: none;"></canvas>
                            <img
                                alt="Scan me!"
                                src="{{$qr_code}}"
                                style="display: block;"
                    ...
                    <div data-v-37526a6c="" class="page-recharge-info">
                        <dl data-v-37526a6c="" class="page-recharge-info-item">
                            <dt data-v-37526a6c="">Select Currency</dt>
                            <dd data-v-37526a6c="">
                                <div data-v-37526a6c="" class="flex items-center">
                                    <img data-v-37526a6c="" src="https://obs.nedvc.com/upload/20240826/ea3ebfe36a82dcb2a01985c01ab7c5fe.png" width="24" height="24" alt="" /><span data-v-37526a6c="" class="px-6px">{{$paymentMode}}</span>
                                </div>
                            </dd>
                        </dl>
                        <dl data-v-37526a6c="" class="page-recharge-info-item">
                            ...
                            <dd data-v-37526a6c="">
                                <div data-v-37526a6c="">{{$amount}}</div>
                                <!-- <svg data-v-37526a6c="" xmlns="http://www.w3.org/2000/svg" width="8" height="6" viewBox="0 0 8 6" fill="none"><path data-v-37526a6c="" d="M0 2V0H8V2L4 6L0 2Z" fill="white"></path></svg> -->
                            </dd>
                        </dl>
                        <dl data-v-37526a6c="" class="page-recharge-info-item">
                            <dt data-v-37526a6c="">Order ID</dt>
                            <dd data-v-37526a6c="">
                                <div data-v-37526a6c="" class="page-recharge-info-address">{{$orderId}}</div>
                                <div data-v-37526a6c="">
                                    <svg data-v-37526a6c="" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                        <path
                                            data-v-37526a6c=""
                                            fill-rule="evenodd"
                                            clip-rule="evenodd"
                        ...
                        <dl data-v-37526a6c="" class="page-recharge-info-item">
                            <dt data-v-37526a6c="">Transaction ID</dt>
                            <dd data-v-37526a6c="">
                                <div data-v-37526a6c="">{{$transaction_id}}</div>
                                <!-- <svg data-v-37526a6c="" xmlns="http://www.w3.org/2000/svg" width="8" height="6" viewBox="0 0 8 6" fill="none"><path data-v-37526a6c="" d="M0 2V0H8V2L4 6L0 2Z" fill="white"></path></svg> -->
                            </dd>
                        </dl>
                        <dl data-v-37526a6c="" class="page-recharge-info-item">
                            <dt data-v-37526a6c="">Send {{$paymentMode}}</dt>
                            <dd data-v-37526a6c="">
                                <div data-v-37526a6c=""> {{$invoice_total_sum}}</div>
                                <!-- <svg data-v-37526a6c="" xmlns="http://www.w3.org/2000/svg" width="8" height="6" viewBox="0 0 8 6" fill="none"><path data-v-37526a6c="" d="M0 2V0H8V2L4 6L0 2Z" fill="white"></path></svg> -->
                            </dd>
                        </dl>
                        <dl data-v-37526a6c="" class="page-recharge-info-item">
                            <dt data-v-37526a6c="">Deposit address</dt>
                            <dd data-v-37526a6c="">
                                <div data-v-37526a6c="" class="page-recharge-info-address" id="wallet_address1">{{$walletAddress}}</div>
                                <div data-v-37526a6c="">
                                    <svg data-v-37526a6c="" xmlns="http://www.w3.org/2000/svg" onclick="copyFunctionwallet()" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                        <path
                                            data-v-37526a6c=""
                                            fill-rule="evenodd"
                                            clip-rule="evenodd"
                        ...
                        <input  name="oID"  id="balance/oper_frm_oID" value="{{$invoice_total_sum}}" type="hidden">
                        ...
                        <a 
    class="rounded-8px van-button van-button--primary van-button--normal van-button--block" style="background: #223f7a; border: 0.02rem solid #080808;"
    href="{{ route('user.cancel-payment', ['id' => $orderId]) }}" 
    onClick="return confirm('Are you sure you want to cancel?');" 
    style="margin-top: 10px; background:#223f7a; color: #fff; text-decoration: none; display: block; text-align: center; padding: 10px 15px;">
    <div class="van-button__content">
        <span class="van-button__text" style="color:#fff">Cancel</span>
    </div>
</a>
                        <!---->
                    </div>
                    ...
                    <div data-v-37526a6c="" class="page-recharge-tips">
                        <div data-v-37526a6c="" class="page-recharge-tips-title">
                            <img
                                data-v-37526a6c=""
                                width="16"
                                height="16"
...
<p data-v-37526a6c=""><p>1. The minimum recharge amount is:  0 USDT<br>
