  ...
  <body class="mein_cn">
    ...
    <div id="app" style="height: 7.82rem;">
        <div data-v-37526a6c="" class="page h-full">
            ...
            <form method="post" action="{{ route('user.fundActivation') }}" name="balance/oper_frm" data-v-56930b78="">
            {{ csrf_field() }}
                <div data-v-37526a6c="" class="container page-recharge">
                    ...
                    <div data-v-37526a6c="" class="page-recharge-info">
                        ...
                        <dl data-v-37526a6c="" class="page-recharge-info-item">
                            ...
                            <dd data-v-37526a6c="">
                                <div data-v-37526a6c="">{{$amount}}</div><svg data-v-37526a6c=""
                                    xmlns="http://www.w3.org/2000/svg" width="8" height="6" viewBox="0 0 8 6"
                                    fill="none">
                                    <path data-v-37526a6c="" d="M0 2V0H8V2L4 6L0 2Z" fill="white"></path>
                                </svg>
                        ...
                        <dl data-v-37526a6c="" class="page-recharge-info-item">
                            ...
                            <dd data-v-37526a6c="">
                        <input data-v-ab1e4d37="" name="oID" type="text"  id="balance/oper_frm_oID" readonly value="{{$invoice_total_sum}}" type="hidden" style="display:none">
                        ...
                        <input name="transaction_id" value="{{$transaction_id}}" type="hidden">
                                ...
                                {{$walletAddress}}</div>
                                <div data-v-37526a6c="">
                                    <svg data-v-37526a6c="" xmlns="http://www.w3.org/2000/svg"
                                        width="16" height="16" viewBox="0 0 16 16" fill="none" onclick="copyFunctionwallet()">
                        ...
                        <input data-v-37526a6c="" name="oID" type="text"  id="balance/oper_frm_oID" readonly value="{{$invoice_total_sum}}" type="hidden" style="color:#fff;    height: 0.8rem;
    border-radius: 0.16rem;
    color:#fff;
    padding: 0 0.3rem;
    ...
    border: 0.02rem solid #252930;
    background: transparent;">
    <button class="rounded-8px van-button van-button--primary van-button--normal van-button--block"style="margin-top: 10px;" type="cancel">
