<html style="font-size: 50px;"><head>
  ...
  */
  ...
  .popup-box .title-box[data-v-283789fa] {
    width: 100%;
    position: relative;
    display: flex;
    align-items: center;
  ...
  .popup-box .title-box .title[data-v-283789fa] {
    width: 80%;
    text-align: center;
    color: #fff;
    position: absolute;
  ...
  .popup-box .title-box .cross[data-v-283789fa] {
    margin-left: auto;
  }
  .popup-box .content[data-v-283789fa] {
    border-radius: 0.4rem;
    padding: 0.4rem 0 0;
  }
  .popup-box .content .tips[data-v-283789fa] {
    border-radius: 0.16rem;
    padding: 0.24rem;
    background: rgba(0, 252, 131, 0.1);
    display: flex;
  }
  .popup-box .content .tips img[data-v-283789fa] {
    width: 0.26rem;
    height: 0.26rem;
    margin-right: 0.12rem;
  }
  ...
  .van-action-sheet__item[data-v-283789fa]:active,
  .van-action-sheet__cancel[data-v-283789fa]:active {
    background-color: #23252e;
  }
  .van-overlay[data-v-283789fa] {
    position: fixed;
    width: 8.5rem;
    left: 50%;
    transform: translateX(-50%);
  ...
  .van-popup--bottom[data-v-283789fa] {
    max-width: 8.5rem;
  }
  </style><style type="text/css">.page-withdraw-info {
    padding: 0.32rem;
    border-radius: 0.16rem;
    border: 0.02rem solid #252930;
  }
  ...
  .page-withdraw-info-input::placeholder {
    color: #4c5361;
  }
  .page-withdraw-info-usdc {
    padding: 0.32rem 0.28rem;
    border-radius: 0.16rem;
    border: 0.02rem solid #252930;
  }
  ...
  <p>v2 withdrawal fee 7%</p>
  
  <p>v3 withdrawal fee 5%</p>
  
  <p>v4 withdrawal fee 5%</p>
  
  <p>v5 withdrawal fee 3%</p>
  
  <p>v6 withdrawal fee 3%</p>
  
  <p>3. For the withdrawal address, please enter the selected corresponding network and currency address. </p>
  
  <p>4. Withdrawal will arrive within 48 hours of withdrawal. </p>
  
  <p>5. The same address can be withdrawn multiple times without affecting the payment. </p>
