...
*/
    ...
    <script charset="utf-8" src="/js/28.86535a9c-1727647884855.js"></script>
    <style type="text/css">
        .page-team-crew {
            height: 100%;
        }
...
<body class="mein_cn">
    ...
    <div id="app" style="height: 5.58rem;">
        <div data-v-37526a6c="" class="page h-full">
            <div data-v-37526a6c="" class="headers on">
                <div data-v-0ff1fb10="" data-v-37526a6c="">
                    <div data-v-0ff1fb10="" class="head">
                        <div data-v-0ff1fb10="" class="name"> My team </div>
            ...
            <div data-v-37526a6c="" id="scroll" class="content-container" style="padding-top: 60px;">
                <div data-v-37526a6c="" id="content" class="content-scroll" style="padding-bottom: 0.3rem;">
                    <div data-v-37526a6c="" class="page-team-crew px-16px overflow-hidden">
                  
                        <ul data-v-37526a6c="" class="mb-12px flex items-center page-team-crew-tab">
                        @for ($l=1;$l<=3;$l++)
                            <a href="{{route('user.referral-team') }}?selected_level={{$l}}">
                            <li data-v-37526a6c="" class="mr-20px flex items-center text-secondary <?php echo  (Session::get('selected_level')==$l)?"active":""?>"> @lang('Level') {{$l}} </li>
                          </a>
                          @endfor
                        </ul>
                       
                        <div class="mb-12px rounded-6px border-solid-dark van-cell van-cell--borderless van-field"
                            data-v-37526a6c="">
                            <div class="van-cell__value van-cell__value--alone van-field__value">
                                <div class="van-field__body"><input type="text" readonly="readonly"
                                        class="van-field__control">
                                    <div class="van-field__right-icon"><i class="van-icon van-icon-arrow-down">
                                            <!----></i></div>
                                </div>
                            </div>
                        </div>
                        <div data-v-37526a6c="" class="page-team-crew-list">
                            <div class="h-full van-pull-refresh" data-v-37526a6c="" style="overflow-y: auto;">
                                <div class="van-pull-refresh__track" style="transition-duration: 0ms;">
                                    <div class="van-pull-refresh__head"></div>
                                    <div role="feed" class="h-full van-list">
                                    <?php if(is_array($direct_team) || is_object($direct_team)){ ?>

<?php $cnt = $direct_team->perPage() * ($direct_team->currentPage() - 1); ?>
@foreach ($direct_team as $value)
                                        <div class="mb-16px p-16px bg-secondary rounded-10px crew-item">
                                            <div class="flex items-center">
                                                ...
                                                <div class="ml-6px">
                                                    <div class="mb-8px flex items-center"><span class="text-14px">
                                                    {{$value->username}} </span>
                                                        <!---->
                                                    </div>
                                                    <div class="text-12px text-gray">{{ date('D, d M Y H:i:s', strtotime($value->created_at)) }}</div>
                                                </div>
                                            </div>
                                            <div role="separator" class="van-divider van-divider--hairline"></div>
                                            <ul class="text-14px">
                                                <li class="mb-12px flex-between-center"><span
                                                        class="text-gray">ID</span><span>{{$value->username}}</span></li>
                                                <!---->
                                                <li class="mb-12px flex-between-center"><span class="text-gray"> Team
                                                        size </span><span><span class="text-primary">0</span> / 0
                                                    </span></li>
                                                <li class="flex-between-center"><span class="text-gray">Income
                                                    </span><span><span class="text-primary"></span>{{ ($value->investment->sum('amount'))?$value->investment->sum('amount'):0 }} </span></li>
        ...
        <div data-v-5954443c="" class="modal-notice-box">
            <div data-v-5954443c="" class="modal-notice">
                ...
                <div data-v-5954443c="" class="notice-desc">
                    <p>Version Update Announcement: The system will undergo an upgrade in the early hours of October
                        7th. VIP0 membership will be canceled at 23:59 on October 6th. Starting from October 7th, all
                        new registered users will receive a 3 USDT registration reward. Thank you for your support and
                        understanding</p>
                </div>
            </div>
    ...
    <div class="van-popup van-popup--round van-popup--bottom" style="z-index: 2005; display: none;">
        <div class="van-picker">
            <div class="van-picker__toolbar"><button type="button" class="van-picker__cancel">Cancel</button>
                <div class="van-ellipsis van-picker__title">Choose a type</div><button type="button"
                    class="van-picker__confirm">Confirm</button>
            </div>
            <!---->
                ...
                <div class="van-picker-column">
                    <ul class="van-picker-column__wrapper"
                        ...
                        <li role="button" tabindex="0" class="van-picker-column__item" style="height: 44px;">
                            <div class="van-ellipsis">All users</div>
                        </li>
                        <li role="button" tabindex="0" class="van-picker-column__item" style="height: 44px;">
                            <div class="van-ellipsis">valid user</div>
                        </li>
                        <li role="button" tabindex="0" class="van-picker-column__item van-picker-column__item--selected"
                            style="height: 44px;">
                            <div class="van-ellipsis">Invalid user</div>
                        </li>
                    </ul>
                </div>
