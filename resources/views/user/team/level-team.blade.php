...
*/
    ...
    <style type="text/css">
        .record-list .record[data-v-1e017342] {
        ...
        <div data-v-37526a6c="" class="page h-full">
            ...
            <div data-v-37526a6c="" id="scroll" class="content-container" style="padding-top: 60px;">
                <div data-v-37526a6c="" id="content" class="content-scroll" style="padding-bottom: 0.3rem;">
                    <div data-v-37526a6c="" class="page-team px-16px">
                        <div data-v-37526a6c="" class="mb-16px bg-secondary rounded-10px over-hidden page-team-header">
                            <ul data-v-37526a6c=""
...
>>>>>>> 5b20338743062f46e31d9b69f22eb2158ed9c8d4
                                ...
                                <ul data-v-37526a6c="" class="flex-between-center">
                                    <li data-v-37526a6c="" class="mb-10px">
                                        <div data-v-37526a6c="" class="mb-10px text-secondary text-12px"> Team size
                                        </div>
                                        <div data-v-37526a6c="" class="text-14px"> {{$active_gen_team1total}}/{{$gen_team1total}} </div>
                                    </li>
                                    <li data-v-37526a6c="" class="mb-10px">
                                        <div data-v-37526a6c="" class="mb-10px text-secondary text-12px"> Team
                                            commission(USDT) </div>
                                        <div data-v-37526a6c="" class="text-14px">0</div>
                                    </li>
                                    <li data-v-37526a6c="" class="mb-10px">
                                        <div data-v-37526a6c="" class="mb-10px text-secondary text-12px"> Today’s team
                                            commission rebate(USDT) </div>
                                        <div data-v-37526a6c="" class="text-14px">{{number_format($gen_teamIncome,2)}}</div>
                                    </li>
                                </ul>
                            </div>
                            <div data-v-37526a6c="" class="mb-16px p-12px border-solid-dark rounded-10px">
                                ...
                                <ul data-v-37526a6c="" class="flex-between-center">
                                    <li data-v-37526a6c="" class="mb-10px">
                                        ...
                                        <div data-v-37526a6c="" class="text-14px"> {{$active_gen_team2total}}/{{$gen_team2total}}</div>
                                    </li>
                                    <li data-v-37526a6c="" class="mb-10px">
                                        <div data-v-37526a6c="" class="mb-10px text-secondary text-12px"> Team
                                            commission(USDT) </div>
                                    ...
                                    <li data-v-37526a6c="" class="mb-10px">
                                        <div data-v-37526a6c="" class="mb-10px text-secondary text-12px"> Today’s team
                                            commission rebate(USDT) </div>
                                        <div data-v-37526a6c="" class="text-14px">{{number_format($gen_team2Income,2)}}</div>
                                    </li>
                                </ul>
                            </div>
                            <div data-v-37526a6c="" class="mb-16px p-12px border-solid-dark rounded-10px">
                                ...
                                <ul data-v-37526a6c="" class="flex-between-center">
                                    <li data-v-37526a6c="" class="mb-10px">
                                        ...
                                        <div data-v-37526a6c="" class="text-14px">{{$active_gen_team3total}}/{{$gen_team3total}} </div>
                                    </li>
                                    <li data-v-37526a6c="" class="mb-10px">
                                        <div data-v-37526a6c="" class="mb-10px text-secondary text-12px"> Team
                                            commission(USDT) </div>
                                    ...
                                    <li data-v-37526a6c="" class="mb-10px">
                                        <div data-v-37526a6c="" class="mb-10px text-secondary text-12px"> Today’s team
                                            commission rebate(USDT) </div>
                                        <div data-v-37526a6c="" class="text-14px">{{number_format($gen_team3Income,2)}}</div>
                                    </li>
                                </ul>
                            </div>
                            <div data-v-37526a6c="" class="mb-16px p-12px border-solid-dark rounded-10px">
                                ...
                                <ul data-v-37526a6c="" class="flex-between-center">
                                    <li data-v-37526a6c="" class="mb-10px">
                                        ...
                                        <div data-v-37526a6c="" class="text-14px"> {{$active_gen_team4total}}/{{$gen_team4total}} </div>
                                    </li>
                                    <li data-v-37526a6c="" class="mb-10px">
                                        <div data-v-37526a6c="" class="mb-10px text-secondary text-12px"> Team
                                            commission(USDT) </div>
                                    ...
                                    <li data-v-37526a6c="" class="mb-10px">
                                        <div data-v-37526a6c="" class="mb-10px text-secondary text-12px"> Today’s team
                                            commission rebate(USDT) </div>
                                        <div data-v-37526a6c="" class="text-14px">{{number_format($gen_team4Income,2)}}</div>
                                    </li>
                                </ul>
                            </div>
                            <div data-v-37526a6c="" class="mb-16px p-12px border-solid-dark rounded-10px">
                                ...
                                <ul data-v-37526a6c="" class="flex-between-center">
                                    <li data-v-37526a6c="" class="mb-10px">
                                        ...
                                        <div data-v-37526a6c="" class="text-14px"> {{$active_gen_team5total}}/{{$gen_team5total}} </div>
                                    </li>
                                    <li data-v-37526a6c="" class="mb-10px">
                                        <div data-v-37526a6c="" class="mb-10px text-secondary text-12px"> Team
                                            commission(USDT) </div>
                                    ...
                                    <li data-v-37526a6c="" class="mb-10px">
                                        <div data-v-37526a6c="" class="mb-10px text-secondary text-12px"> Today’s team
                                            commission rebate(USDT) </div>
                                        <div data-v-37526a6c="" class="text-14px">{{number_format($gen_team5Income,2)}}</div>
                                    </li>
                                </ul>
                            </div>
                            <div data-v-37526a6c="" class="mb-16px p-12px border-solid-dark rounded-10px">
                                ...
                                <ul data-v-37526a6c="" class="flex-between-center">
                                    <li data-v-37526a6c="" class="mb-10px">
                                        ...
                                        <div data-v-37526a6c="" class="text-14px"> {{$active_gen_team6total}}/{{$gen_team6total}}</div>
                                    </li>
                                    <li data-v-37526a6c="" class="mb-10px">
                                        <div data-v-37526a6c="" class="mb-10px text-secondary text-12px"> Team
                                            commission(USDT) </div>
                                    ...
                                    <li data-v-37526a6c="" class="mb-10px">
                                        <div data-v-37526a6c="" class="mb-10px text-secondary text-12px"> Today’s team
                                            commission rebate(USDT) </div>
                                        <div data-v-37526a6c="" class="text-14px">{{number_format($gen_team6Income,2)}}</div>
                                    </li>
                                </ul>
                            </div>
                        </div>
    ...
    <!---->
    <div class="van-overlay" style="z-index: 2010; display: none;"></div>
    <div data-v-5954443c="" class="van-popup van-popup--round van-popup--center"
        style="background: none; z-index: 2011; display: none;">
