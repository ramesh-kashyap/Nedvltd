...
<div id="app" style="height: 5.18rem;">
    <div data-v-0d4b9075="" class="h-full">
        <div data-v-37526a6c="" data-v-0d4b9075="" class="page">
            <div data-v-37526a6c="" class="headers on">
                <div data-v-0ff1fb10="" data-v-0d4b9075="" data-v-37526a6c="">
                    <div data-v-0ff1fb10="" class="head">
                        <div data-v-0ff1fb10="" class="name">Personal income details</div>
            ...
            <div data-v-37526a6c="" id="scroll" class="content-container" style="padding-top: 60px;">
                <div data-v-37526a6c="" id="content" class="content-scroll" style="padding-bottom: 0.3rem;">
                    <div data-v-0d4b9075="" data-v-37526a6c="" class="container">
                        <div data-v-57772884="" data-v-0d4b9075="" class="assets" data-v-37526a6c="">
                            <div data-v-57772884="" class="info-list">
                                <div data-v-57772884="" class="info">
                                    <div data-v-57772884="" class="name">Cumulative total income</div>
                                    <div data-v-57772884="" class="value">{{number_format($total_income,2)}}</div>
                                </div>
                                <div data-v-57772884="" class="info">
                                    <div data-v-57772884="" class="name">Cumulative task income</div>
                                    <div data-v-57772884="" class="value">{{number_format($total_task_income,2)}}</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div data-v-0d4b9075="" class="van-pull-refresh" data-v-37526a6c="">
                            <div class="van-pull-refresh__track" style="transition-duration: 0ms;">
                                <div class="van-pull-refresh__head" style="height: 50px;"></div>
                                <div data-v-0d4b9075="" role="feed" class="van-list">
                                  
                                <?php if(is_array($task_income) || is_object($task_income)){ ?>

<?php
 date_default_timezone_set('UTC');
  $cnt = 0; ?>
  @foreach($task_income as $value)

                                    <div data-v-1e017342="" data-v-0d4b9075="" class="record-list">
                                        <div data-v-1e017342="" class="record">
                                            <div data-v-1e017342="" class="left">
                                                <div data-v-1e017342="" class="name">{{$value->remarks}}</div>
                                                <div data-v-1e017342="" class="time">{{ date('D, d M Y H:i:s', strtotime($value->created_at)) }}</div>
                                            </div>
                                            <div data-v-1e017342="" class="right">
                                                <div data-v-1e017342="" class="price">{{$value->amt}} USDT</div>
                                                <div data-v-1e017342="" class="status">Issued</div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="van-list__finished-text"> {{ $task_income->withQueryString()->links() }}</div>
