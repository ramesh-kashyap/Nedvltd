<html style="font-size: 50px;">
  ...
  */
        ...
        <script charset="utf-8" src="/js/87.35b764a7-1727614688907.js"></script>
        <style type="text/css">
        ...
        .check-in-streak .streak-title i {
            font-size: 18px;
        }
        ...
        .check-in-streak .day.today .icon {
            background-color: #ffcc00;
        }
        .check-in-streak .day .icon i {
            font-size: 24px;
        }
        .check-in-streak .day .bonus {
            font-size: 14px;
        }
        .check-in-streak .next-check-in {
            text-align: center;
            margin-top: 20px;
            color: #ff4d4d;
            font-size: 10px;
        ...
        .general-benefits .benefit {
            display: flex;
            justify-content: space-between;
            align-items: center;
            margin-bottom: 20px;
        }
        .general-benefits .benefit .description {
            flex: 1;
        }
        .general-benefits .benefit .description .title {
            font-size: 18px;
            margin-bottom: 5px;
        }
        .general-benefits .benefit .description .details {
            /* display: inline-flex; */
  align-items: center; /* Align the image and text vertically */
            font-size: 8px;
            color: #b3b3b3;
        }
        .general-benefits .benefit .go-button {
            background-color: #23252e;
            color: white;
            padding: 5px 20px;
            border-radius: 100px;
  ...
  height: 22px;
  width: 22px;
  padding-bottom: 0; /* Remove padding-bottom, it's not needed for alignment */
}
.coin_text{
    color:	#ecdb14; 
    /* font-weight: bold; */
...
.adust{
    ...
    <body class="mein_cn">
        ...
        <div id="app" style="height: 6.24rem;">
            <div data-v-37526a6c="" data-v-6ac1c7f6="" class="page h-full">
                <div data-v-6ac1c7f6="" data-v-37526a6c="" class="bg"></div>
                <div data-v-37526a6c="" class="page-header">
                    <div data-v-0ff1fb10="" data-v-6ac1c7f6="" data-v-37526a6c="">
                        <div data-v-0ff1fb10="" class="head">
                            <div data-v-0ff1fb10="" class="name">Earn Rewards</div>
                            <div data-v-0ff1fb10="" class="container flex">
                                <!---->
                                <div data-v-0ff1fb10="" class="logo"></div>
                                <div data-v-0ff1fb10="" class="back" onclick="location.href='{{route('user.dashboard')}}'">
                                    <img
                                        data-v-0ff1fb10=""
                ...
                <div data-v-37526a6c="" id="scroll" class="page-container" style="padding-bottom: 0px;">
                    ...
                    <div data-v-6ac1c7f6="" data-v-37526a6c="" class="container">
                        <!-- <div class="header">
                            <div class="back-button"><i class="fas fa-arrow-left"></i></div>
                            <div class="time"> <i class="fas fa-bed"></i></div>
                            <div class="icons">
                        ...
                        <div class="adust">
                        <div class="bonus">
                            <img src="{{asset('')}}static/img/Icon/dollar.png" alt="" style="height: 22px;
  width: 22px;" > My Bonus 0
                        </div>
                        <div class="check-in-streak">
                            <div class="streak-title">
                                <div>Check-In Streak: <span style="color: #ff4d4d;">3 Days</span></div>
                                <!-- <i class="fas fa-info-circle"></i> -->
                            </div>
                            <div class="days">
                                <div class="day">
                                    <div class="icon"><img src="{{asset('')}}static/img/Icon/dollar.png" alt="" style="padding-bottom: 10px;">
                                    +30</div>
                                    <div class="d">DAY 1</div>
                                </div>
                                <div class="day">
                                    <div class="icon"><img src="{{asset('')}}static/img/Icon/dollar.png" alt="" style="padding-bottom: 10px;">
                                    +30</div>
                                    <div class="d">DAY 2</div>
                                </div>
                                <div class="day today">
                                    <div class="icon"><img src="{{asset('')}}static/img/Icon/dollar.png" alt="" style="padding-bottom: 10px;">+50</div>
                                    <div class="d">Today</div>
                                </div>
                                <div class="day">
                                    <div class="icon"><img src="{{asset('')}}static/img/Icon/dollar.png" alt="" style="padding-bottom: 10px;">+30</div>
                                    <div class="d">DAY 4</div>
                                </div>
                                <div class="day">
                                    <div class="icon"><img src="{{asset('')}}static/img/Icon/dollar.png" alt="" style="padding-bottom: 10px;">+30</div>
                                    <div class="d">DAY 5</div>
                                </div>
                                <div class="day">
                                    <div class="icon"><img src="{{asset('')}}static/img/Icon/dollar.png" alt="" style="padding-bottom: 10px;">+60</div>
                                    <div class="d">DAY 6</div>
                                </div>
                                <div class="day">
                                    <div class="icon"><img src="{{asset('')}}static/img/Icon/dollar.png" alt="" style="padding-bottom: 10px;">+90</div>
                                    <div class="d">DAY 7</div>
                                </div>
                            </div>
                            <div class="next-check-in "  >Next check-in 17 : 43 : 34</div>
                            <div class="check-more" style="font-size: 12px; margin-bottom: 2px;">Check more (Ad)<br><span style="display: block; margin-top: 0px; font-size: 6px;">Earn up to 40 bonus (1/10) </span></div>
                        </div>
                       
                        <div class="general-benefits">
                            <div class="title" >General Benefits</div>
                            <div class="benefit">
                                <div class="description">
                                    <div class="details"> <img src="{{asset('')}}static/img/Icon/dollar.png" alt="" ><span class="coin_text">4 Bonus (0/10)</span></div>
                                    <div class="details">Watch ads to gain more rewards</div>
                                </div>
                                <div class="go-button">Go</div>
                            </div>
                            <div class="benefit">
                                <div class="description">
                                    <div class="details"> <img src="{{asset('')}}static/img/Icon/dollar.png" alt="" >
                                        <span  class="coin_text">  10 Bonus</span></div>
                                    <div class="details">Give a 5-star rating in the App Store</div>
                                </div>
                                <div class="go-button">Go</div>
                            </div>
                            <div class="benefit">
                                <div class="description">
                                    <div class="details"> <img src="{{asset('')}}static/img/Icon/dollar.png" alt="" ><span  class="coin_text">3 Bonus</span></div>
                                    <div class="details">Follow us on Facebook to get a reward</div>
                                </div>
                                <div class="go-button">Go</div>
                            </div>
                            <div class="benefit">
                                <div class="description">
                                    <div class="details"> <img src="{{asset('')}}static/img/Icon/dollar.png" alt="" ><span class="coin_text">3 Bonus</span></div>
                                    <div class="details">Follow us on TikTok to get a reward</div>
                                </div>
                                <div class="go-button">Go</div>
                            </div>
                            <div class="benefit">
                                <div class="description">
                                    <div class="details"> <img src="{{asset('')}}static/img/Icon/dollar.png" alt="" ><span class="coin_text">3 Bonus</span></div>
                                    <div class="details">Follow us on Instagram to get a reward</div>
                                </div>
                                <div class="go-button">Go</div>
                            </div>
                        </div>
        ...
        <div data-v-5954443c="" class="van-popup van-popup--round van-popup--center" style="background: none; z-index: 2002; display: none;">
            <div data-v-5954443c="" class="modal-notice-box">
                <div data-v-5954443c="" class="modal-notice">
                    <div data-v-5954443c="" class="notice-top"><img data-v-5954443c="" src="/static/img/noticetopbg.69a72412.png" alt="" /></div>
                    ...
                    <div data-v-5954443c="" class="notice-desc">
                        ...
                        <p>
                            From September 26 00:00 to September 30 23:59 (France time) inviting new friends to subscribe to VIP membership will earn an additional reward of 3 USDT while new VIP members will receive an additional reward of
                            5 USDT Please contact the manager to claim your rewards
                        </p>
                    </div>
                </div>
                <div data-v-5954443c="" class="close">
                    <img
                        data-v-5954443c=""
