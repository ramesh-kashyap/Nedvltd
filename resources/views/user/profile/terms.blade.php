...
</style><script charset="utf-8" src="/js/14.86535a9c-1727647884855.js"></script><style type="text/css">.video-task-card[data-v-5f8b7283] {
width: 100%;
background: url(/static/img/bg-task-card.c7cba0e2.png) no-repeat;
background-size: 100% 100%;
line-height: 1.2;
}
.video-task-card .card[data-v-5f8b7283] {
padding: 0.4rem 0.32rem;
}
.video-task-card .card .card-top .name[data-v-5f8b7283] {
color: #FFF;
font-size: 0.4rem;
}
.video-task-card .card .card-top .text[data-v-5f8b7283] {
margin-top: 0.12rem;
color: rgba(255, 255, 255, 0.6);
font-size: 0.32rem;
}
.video-task-card .card .card-bot[data-v-5f8b7283] {
margin-top: 0.4rem;
display: flex;
align-items: center;
justify-content: space-between;
...
.video-task-card .card .card-bot .btn[data-v-5f8b7283] {
min-height: 0.72rem;
height: fit-content;
padding: 0.12rem;
border-radius: 0.16rem;
...
.video-task-card .card .card-bot .btn[data-v-5f8b7283]:nth-of-type(2) {
color: var(--color1);
background: linear-gradient(0deg, rgba(0, 252, 131, 0.4) 0%, rgba(0, 252, 131, 0) 100%);
}
.van-field__word-num[data-v-5f8b7283] {
color: #fff;
}
.van-action-sheet__item[data-v-5f8b7283]:active,
.van-action-sheet__cancel[data-v-5f8b7283]:active {
background-color: #23252e;
}
.van-overlay[data-v-5f8b7283] {
position: fixed;
width: 8.5rem;
left: 50%;
transform: translateX(-50%);
...
.van-popup--bottom[data-v-5f8b7283] {
max-width: 8.5rem;
}
</style><style type="text/css">.list[data-v-3b959957] {
line-height: 1.2;
}
.list .item[data-v-3b959957] {
border-radius: 0.2rem;
border: 0.03rem solid #00fc83;
padding: 0.32rem 0.28rem;
}
.list .item .head[data-v-3b959957] {
display: flex;
align-items: center;
justify-content: space-between;
padding-bottom: 0.32rem;
...
.list .item .head .level-box[data-v-3b959957] {
display: flex;
align-items: center;
}
.list .item .head .level-box img[data-v-3b959957] {
min-width: 0.48rem;
height: 0.48rem;
margin-right: 0.12rem;
}
.list .item .head .level-box span[data-v-3b959957] {
color: #fff;
font-size: 0.32rem;
}
.list .item .head .status[data-v-3b959957] {
...
.list .item .head .status.active[data-v-3b959957] {
background: var(--color1);
color: #1B1C21;
}
.list .item .info-list[data-v-3b959957] {
display: flex;
justify-content: space-between;
flex-wrap: wrap;
}
.list .item .info-list .info[data-v-3b959957] {
flex: 0 0 33%;
}
.list .item .info-list .info[data-v-3b959957]:nth-of-type(3n+2) {
text-align: center;
}
.list .item .info-list .info[data-v-3b959957]:nth-of-type(3n) {
text-align: right;
}
.list .item .info-list .info .name[data-v-3b959957] {
margin-top: 0.32rem;
color: #787f8e;
font-size: 0.28rem;
}
.list .item .info-list .info .value[data-v-3b959957] {
margin-top: 0.2rem;
color: #fff;
font-size: 0.32rem;
}
.list .item .info-list .info .value.min[data-v-3b959957] {
font-size: 0.24rem;
}
.list .item .info-list .info .value span[data-v-3b959957] {
font-size: 0.2rem;
}
.list .item .count-down[data-v-3b959957] {
margin-top: 0.24rem;
padding: 0.24rem 0.28rem;
border-radius: 0.16rem;
background: #1B1C21;
...
.list .item .count-down .van-count-down[data-v-3b959957] {
font-size: 0.26rem;
color: #FF5050;
text-align: right;
}
.list .item .count-down .van-count-down .colon[data-v-3b959957] {
color: rgba(255, 255, 255, 0.8);
}
.list .item .bot[data-v-3b959957] {
display: flex;
align-items: center;
gap: 0.24rem;
}
.list .item .bot .btn[data-v-3b959957] {
flex: 1;
height: 0.72rem !important;
margin-top: 0.32rem;
border-radius: 0.16rem;
...
.list .item .bot .btn.status0[data-v-3b959957] {
color: #FFBD59;
border: 0.02rem solid #FFBD59;
background: linear-gradient(0deg, rgba(255, 189, 89, 0.1) 0%, rgba(255, 189, 89, 0) 100%);
}
.list .item .bot .btn.status1[data-v-3b959957] {
color: var(--color1);
border: 0.02rem solid var(--color1);
background: linear-gradient(0deg, rgba(0, 252, 131, 0.1) 0%, rgba(0, 252, 131, 0) 100%);
}
.list .item .bot .btn.status2[data-v-3b959957] {
background: #23252E;
color: #E94E61;
}
.list .item .bot .btn.status3[data-v-3b959957] {
background: var(--color1);
color: #020202;
}
.list .item .bot .btn.ashes[data-v-3b959957] {
background: #23252E;
color: rgba(255, 255, 255, 0.6);
}
.van-field__word-num[data-v-3b959957] {
color: #fff;
}
.van-action-sheet__item[data-v-3b959957]:active,
.van-action-sheet__cancel[data-v-3b959957]:active {
background-color: #23252e;
}
.van-overlay[data-v-3b959957] {
position: fixed;
width: 8.5rem;
left: 50%;
transform: translateX(-50%);
...
.van-popup--bottom[data-v-3b959957] {
max-width: 8.5rem;
}
</style><style type="text/css">.info-list[data-v-00132bf6] {
padding: 0.32rem;
border-radius: 0.16rem;
border: 0.02rem solid #00FC83;
line-height: 1.2;
...
.info-list .info[data-v-00132bf6] {
flex: 1;
}
.info-list .info .value[data-v-00132bf6] {
color: #FFF;
font-size: 0.28rem;
}
.info-list .info .name[data-v-00132bf6] {
color: rgba(255, 255, 255, 0.6);
font-size: 0.22rem;
}
.van-field__word-num[data-v-00132bf6] {
color: #fff;
}
.van-action-sheet__item[data-v-00132bf6]:active,
.van-action-sheet__cancel[data-v-00132bf6]:active {
background-color: #23252e;
}
.van-overlay[data-v-00132bf6] {
position: fixed;
width: 8.5rem;
left: 50%;
transform: translateX(-50%);
...
.van-popup--bottom[data-v-00132bf6] {
max-width: 8.5rem;
}
...
<div id="app" style="height: 5.7rem;"><div data-v-37526a6c="" data-v-6bda6362="" class="page h-full"><div data-v-37526a6c="" class="headers on"><div data-v-0ff1fb10="" data-v-6bda6362="" data-v-37526a6c=""><div data-v-0ff1fb10="" class="head"><div data-v-0ff1fb10="" class="name"> RULE </div><div data-v-0ff1fb10="" class="container flex"><!----><div data-v-0ff1fb10="" class="logo"></div><div data-v-0ff1fb10="" class="back"><img data-v-0ff1fb10="" src="data:image/png;base64," alt=""></div><div data-v-0ff1fb10="" class="flex1"></div><!----><!----><!----><!----><!----></div></div></div></div><div data-v-37526a6c="" id="scroll" class="content-container" style="padding-top: 60px;"><div data-v-37526a6c="" id="content" class="content-scroll" style="padding-bottom: 0.3rem;"><div data-v-6bda6362="" data-v-37526a6c="" class="container"><div data-v-6bda6362="" data-v-37526a6c="" class="p"><p><img src="http://nedvc-all.s3.ap-northeast-3.amazonaws.com/upload/20240723/c148dd24cfd86e3358a3bd7e66c74d6a.png"><img src="http://nedvc-all.s3.ap-northeast-3.amazonaws.com/upload/20240723/03149481af17b87e304f519a5df8a3bc.png"><img src="http://nedvc-all.s3.ap-northeast-3.amazonaws.com/upload/20240723/2558435176ab7313bc001efd689cc162.png"><img src="http://nedvc-all.s3.ap-northeast-3.amazonaws.com/upload/20240723/751ffd08fe224614d365139b979c6570.png"><img src="http://nedvc-all.s3.ap-northeast-3.amazonaws.com/upload/20240723/0e19ab53fe0a384a59f9d6d042b7e9b8.png"><img src="http://nedvc-all.s3.ap-northeast-3.amazonaws.com/upload/20240723/d8aae5d47d9d29007d6f48e346492f03.png"></p></div></div></div></div><!----></div><div data-v-15b106f9="" class="page-loading-con" style="display: none;"><div data-v-15b106f9="" class="page-loading"></div><p data-v-15b106f9="">Loading...</p></div></div>
