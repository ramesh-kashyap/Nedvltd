    ...
    <div id="app" style="height: 7.82rem;">
        <div data-v-37526a6c="" data-v-3db22916="" class="page h-full">
            ...
            <div data-v-37526a6c="" id="scroll" class="content-container" style="padding-top: 60px;">
                <form method="post" action="{{ route('user.bindemail-action') }}">
                {{ csrf_field() }}
                <div data-v-37526a6c="" id="content" class="content-scroll" style="padding-bottom: 0.3rem;">
                    <div data-v-3db22916="" data-v-37526a6c="" class="old-email">{{Auth::user()->username}}</div>
                    <div data-v-3db22916="" data-v-37526a6c="" class="container">
                        <div data-v-3cceea5e="" data-v-3db22916="" class="input_big_box mt" data-v-37526a6c="">
                            <div data-v-3cceea5e="" class="title_box">
                                <div data-v-3cceea5e="" class="title">Current User ID</div>
                            </div>
                            <div data-v-3cceea5e="" class="inp_content_box">
                                <div data-v-3cceea5e="" class="input"><input data-v-3cceea5e=""
                                 type="text" readonly="" value="{{Auth::user()->username}}"></div>
                        ...
                        <div data-v-3670e178="" data-v-3db22916="" class="input_big_box mt" data-v-37526a6c="">
                            ...
                            <div data-v-3670e178="" class="inp_content_box">
                                <div data-v-3670e178="" class="input"><input data-v-3670e178="" id="emailId" 
                                 value="{{Auth::user()->email}}" type="email" name="emailId" placeholder="Enter the email address">
                                </div>
                            </div>
                        </div>
                        <div data-v-3cceea5e="" data-v-3db22916="" class="input_big_box mt" data-v-37526a6c="">
                            <div data-v-3cceea5e="" class="title_box">
                                <div data-v-3cceea5e="" class="title">Email verification code</div>
                            </div>
                            <div data-v-3cceea5e="" class="inp_content_box">
                                <div data-v-3cceea5e="" class="input"><input data-v-3cceea5e="" name="code" type="text"
                                        placeholder="Please enter verification code"></div>
                                <div data-v-3cceea5e="" class="inp_right send_text"><span data-v-3cceea5e=""  class="code-btn">Send</span>
                                </div>
                            </div>
                        </div>
                    </div>
